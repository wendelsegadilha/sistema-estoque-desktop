...
public class FormularioFuncionarios extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FormularioFuncionarios.class.getName());
    ...
    private void carregarFuncionarios(String filtro) {
        ...
        if (filtro != null && !filtro.isEmpty()) {
            funcionarios = dao.filtarPorNome(filtro);
        } else {
    ...
    private void initComponents() {
        ...
        cmbNivelAcesso.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ADMINISTRADOR", "USUARIO" }));
        ...
        tblFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD", "NOME", "RG", "CPF", "E-MAIL", "SENHA", "CARGO", "ACESSO", "TELEFONE", "CELULAR", "CEP", "ENDERECO", "NUMERO", "COMPLEMENTO", "BAIRRO", "CIDADE", "ESTADO"
            }
        ));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        funcionario.setNivelAcesso(cmbNivelAcesso.getSelectedItem().toString());
    ...
    private void tblFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblFuncionariosMouseClicked
        ...
        cmbNivelAcesso.setSelectedItem(tblFuncionarios.getValueAt(tblFuncionarios.getSelectedRow(), 7).toString());
        ...
        cmbEstado.setSelectedItem(tblFuncionarios.getValueAt(tblFuncionarios.getSelectedRow(), 16).toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FormularioFuncionarios().setVisible(true));
    }
